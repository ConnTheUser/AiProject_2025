...
import { copyToClipboard,runCode, useWindowSize } from "../utils";
...
// export async function isInstall() {
  
//   useEffect(() => {
//     fetch('/api/is-matlab-installed')
//       .then(response => response.json())
//       .then(data => setIsMatlabAvailable(data.isInstalled))
//       .catch(error => console.error('Error checking MATLAB installation:', error));
//   }, []);
// }
